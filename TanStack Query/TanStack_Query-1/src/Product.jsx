        ...
        <div className="md:w-1/2 p-8 flex flex-col justify-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-8">
            ...
            <div className="flex items-center">
              ...
              <span className={`font-bold ${product?.availabilityStatus === "In Stock" ? "text-green-600" : "text-red-600"}`}>
                {product?.availabilityStatus}
              </span>
              <span className="ml-1 text-gray-600">({product?.stock} in stock)</span>
            </div>
            <div className="flex items-center">
              <span className="font-semibold text-gray-800 mr-2">Shipping:</span>
              <span className="text-gray-600">{product?.shippingInformation}</span>
            </div>
            <div className="flex items-center">
              <span className="font-semibold text-gray-800 mr-2">Warranty:</span>
